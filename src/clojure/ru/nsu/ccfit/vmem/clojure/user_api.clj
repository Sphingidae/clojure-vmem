...
(defn join-set-conflict-analyzer
  ...
  (fn [[elems1 added1 removed1] [elems2 added2 removed2]]
...
(defn join-stack-conflict-analyzer
  ...
  (fn [[elems1 pushed1 popnum1] [elems2 pushed2 popnum2]]
...
(defn join-queue-conflict-analyzer
  ...
  (fn[[elems1 added1 remnum1] [elems2 added2 remnum2]]
    ...
    (cond
      ...
      ;;if nothing equal, let's switch the arguments
      :else (join-queue-conflict-analyzer [elems2 added2 remnum2] [elems1 added1 remnum1]))))
